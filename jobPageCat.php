...
if(isset($_GET['catName'])){
    if($_GET['catName']==='All'){
        ...
        $query="select * from jobs where jobCategory='".$_GET['catName']."'";
        //                        echo $query;
    }       
}
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="login.php?flag=4&catName=<?php echo $name;?>">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <ul class="list-unstyled">
                                ...
                                while($row=mysqli_fetch_assoc($run)){
                                    echo "<li><a href='jobPageCat.php?catName=".$row['categoryName']."'>".$row['categoryName']."</a></li>";
                                }
