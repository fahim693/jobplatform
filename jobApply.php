...
if(!isset($_SESSION['login'])){    
    header('Location:errorMsg.php?id='.$id.'&flag=0');
    ...
    $skills=mysqli_real_escape_string($conn,$_SESSION['skill']);

    $insertion="insert into jobApplication(applicantName,applicantEmail,appliedJobTitle,appliedJobCompany,skills) values('".$_SESSION['user']."','".$_SESSION['email']."','".$title."','".$company."','".$skills."')";
